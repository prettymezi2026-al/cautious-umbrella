...
try {
  ...
  console.error("Failed to load spelling_data.json:", err);
}
...
// 5. Submit Boss Duel Result (Deducts 100 gold, updates high scores)
...
// 6. Get Rankings (Tab A: Boss High Score, Tab B: Total Play Count)
...
app.listen(PORT, () => {
  console.log(`=======================================================`);
  console.log(`  [집현전 맞춤법 대결 웹앱 서버 실행 완료]`);
